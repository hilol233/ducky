<template>
  <div class="hero" @click="clickOutside">
    <h1 class="hero__title">Your Boosts</h1>
    <p class="hero__text">
      Use Boosts to promote your listings! Boost an item to feature it above
      regular listings. Increase your exposure and get quicker sales!
    </p>
